...
class EvidenceInsertionService {
  public constructor(
    ...
    projectMemoryInbox: IDurableMemoryInbox owned by Project Memory,
    personalMemoryInbox: IDurableMemoryInbox owned by Personal Memory,
    practiceMemoryInbox: IDurableMemoryInbox owned by Practice Memory,
    sqliteDatabase: SqliteDatabase
  ) {}

  public async insert(input: validated targeted insertion input): TargetedInsertionResult {
