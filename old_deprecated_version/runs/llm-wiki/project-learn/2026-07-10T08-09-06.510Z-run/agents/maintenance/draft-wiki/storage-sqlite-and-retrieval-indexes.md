...
Vector dimensions belong to each embedding provider contract rather than a global setting. The default automatic order is Ollama Nomic at 768 dimensions, Ollama Qwen at 768 dimensions, then Gemini at 768 dimensions. Provider/model/dimension identities remain separate metadata contracts even when they share a vector-table width.
