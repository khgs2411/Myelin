...
- The repository has many historical design files under `docs/archive/` and `docs/design/`; active canonical docs, current code, and regression tests are higher authority for present behavior.
- Some roadmap content is more current than older alignment text; resolve conflicts using the sources named in [Roadmap, ADRs, and Design History](roadmap-adrs-and-design-history.md).
