...
- The repository has many historical design files under `docs/archive/` and `docs/design/`; active canonical docs, current code, and regression tests are higher-authority evidence.
- Some roadmap content is more current than older alignment text; preserve material conflicts rather than silently averaging them.
