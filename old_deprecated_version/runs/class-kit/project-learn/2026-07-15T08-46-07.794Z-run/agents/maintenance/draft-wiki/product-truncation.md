...
ClassKit has no permanent product-deletion operation. `truncate` is a destructive reset that preserves the product's identity and configuration rather than removing the product itself.
