...
- [Platform product operations](platform-product-operations.md) — level-100 product reset/truncation, preserved configuration, and manager-baseline restoration.
