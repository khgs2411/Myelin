...
The deterministic checkout record identifies the current repository as the available `master` checkout with an `origin` remote; see [repository identity](../state/repository-identity.json).
